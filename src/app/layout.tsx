...
export const metadata: Metadata = {
  title: "Львівська Кав'ярня - Локальна Кава & Атмосфера",
  description: "Автентична локальна кав'ярня в Львові з якісною кавою, випічкою та затишною атмосферою. Ідеальне місце для роботи та спілкування.",
  keywords: "кав'ярня, кава, Львів, локальна, еспресо, капучино, затишна атмосфера, українська",
  openGraph: {
    title: "Львівська Кав'ярня",
    description: "Локальна кав'ярня з якісною кавою та українським гостинством",
    siteName: "Львівська Кав'ярня",
    type: "website"
  },
  twitter: {
